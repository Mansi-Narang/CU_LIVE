...
const OrganiserCard = ({ event }) => {
  return (
    ...
    >
      <CardMedia component="img" image={event.image} alt="Event Poster" sx={{
        height: "348px",
        width: "500px"
      }} />
      ...
      <CardContent sx={{ padding: "0.5rem" }}>
        <Typography variant="body2" color="textSecondary">
          <p className="flex items-center gap-1">
            <CalendarMonthIcon fontSize="small" /> {event.date}
          </p>
      ...
      {/* Button to Edit or Manage Event */}
      <Button
        sx={{
          margin: "0.5rem auto",
          display: "block",
